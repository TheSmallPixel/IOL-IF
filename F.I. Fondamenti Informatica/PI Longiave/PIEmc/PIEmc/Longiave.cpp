...
void valutaCaso(cella matricola1, cella matricola2) {
	...
	bool checkSecondiMin = matricola1.secondi >= TEMPO_MINIMO_CASO && matricola1.secondi >= TEMPO_MINIMO_CASO;
	//verifica che non sia una persona
	if (matricola1.isPerson() && matricola2.isPerson() && checkSecondiMin) {
		//Verifica caso critico
		bool checkCriticTime = matricola1.secondi >= TEMPO_MINIMO_CASO_CRITICO && matricola2.secondi >= TEMPO_MINIMO_CASO_CRITICO;
